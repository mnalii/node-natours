...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW5hbGkyMjA1OTQiLCJhIjoiY2tsNXhpd3FjMmJpZjJwcW9jd2NpcnN1ZyJ9.CkP_2SuQJuHZTytz-Qdfmw';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IPfBoDc8Z247Ze7GB24udpMar9ndKezw2qsrLaK9wAVVb5Cntxq6vh8Pan73CqUkDq4tkxdj4OwM86PDLoyZPxx00EQmZI4TU');
            _context.prev = 1;
            _context.next = 4;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              document.querySelector('.user-name-text').textContent = fullName[0];
